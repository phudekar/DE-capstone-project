...
def test_histogram_observe():
    ...
    dagster_asset_materialization_duration_seconds.labels(asset_key="silver_trades", layer="silver").observe(5.0)
...
def test_gauge_set():
    ...
    dagster_asset_freshness_seconds.labels(asset_key="gold_daily_trading_summary", layer="gold").set(3600.0)
