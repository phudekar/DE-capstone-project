...
RAW_TRADES_SCHEMA = Schema(
    ...
    NestedField(5, "buy_order_id", StringType(), required=True),
    NestedField(6, "sell_order_id", StringType(), required=True),
    NestedField(7, "buyer_agent_id", StringType(), required=True),
    NestedField(8, "seller_agent_id", StringType(), required=True),
    NestedField(9, "is_aggressive_buy", BooleanType(), required=True),
